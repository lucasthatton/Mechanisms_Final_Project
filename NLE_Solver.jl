...
# ╔═╡ b06455f2-2fb6-4e2b-bab6-18c52e3fc2dc
using ModelingToolkit, NonlinearSolve

# ╔═╡ baeb6c2a-d941-11ec-231d-43789113efd7
begin

	@variables θ3(θ2) θ4(θ2)
	@parameters θ2 r1 r2 r3 r4 θ1
	
	eqs = [
		0 ~ r2*cos(θ2) + r3*cos(θ3) + r4*cos(θ4)-r1*cos(θ1),
		0 ~ r2*sin(θ2) + r3*sin(θ3) + r4*sin(θ4)-r1*sin(θ1)
	]
	
	# @named ns = NonlinearSystem(eqs, [θ2, θ3, θ4], [r1, r2, r3, r4, θ1])
	
end

# ╔═╡ 85c926a8-1160-4d90-8dbf-681e10573bf9
begin
	a = 850/4
	guess = [
		"r1" => 4*a
